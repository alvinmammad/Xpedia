...
namespace Xpedia.Areas.Manage.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,Desc,Address,Phone,Email")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,Desc,Address,Phone,Email")] Contact contact)
        {
            if (ModelState.IsValid)
            {
